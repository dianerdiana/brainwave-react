    ...
    <Section id="how-to-use">
      <div className="container">
        ...
        <div className="relative">
          <div className="relative z-1 flex items-center h-[39rem] mb-5 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:-[46rem]">
          ...
          <div className="relative grid gap-5 z-1 lg:grid-cols-2">
            ...
            <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
              <div className="px-4 p-w-12 xl:px-8">
